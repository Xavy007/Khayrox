    ...
    <main className="flex-1 flex flex-col bg-background overflow-hidden" ref={containerRef}>
      ...
      <section className="relative w-full h-[100vh] min-h-[850px] flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ y: float1Y }} className="absolute top-[20%] left-[2%] z-0 hidden xl:block opacity-20">
          <div className="w-32 h-32 rounded-3xl bg-gradient-to-tr from-primary/40 to-transparent border border-primary/20 backdrop-blur-md animate-[spin_20s_linear_infinite] shadow-[0_0_50px_rgba(212,175,55,0.25)]" />
        </motion.div>
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 mb-6">
              ...
              >
                ...
                <span className="flex h-2.5 w-2.5 rounded-full bg-primary animate-pulse mr-3 shadow-[0_0_10px_rgba(212,175,55,1)]"></span>
 ...
 */}
            <motion.h1
              ...
              className="text-4xl sm:text-7xl lg:text-8xl font-black tracking-widest bg-gradient-to-r from-white via-[#d4af37] to-[#a37a24] bg-clip-text text-transparent font-orbitron mb-6 leading-tight drop-shadow-[0_0_30px_rgba(212,175,55,0.4)]"
            >
              KHAYROX
            </motion.h1>
            ...
            >
              <Link
                href="/catalogo"
                className="group relative inline-flex h-14 sm:h-16 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-r from-primary to-secondary px-8 sm:px-10 font-bold text-background transition-all duration-300 hover:scale-105 hover:shadow-[0_0_45px_rgba(212,175,55,0.5)]"
              >
          ...
          <motion.div
            ...
            className="flex-1 w-full max-w-lg lg:max-w-none relative aspect-[4/3] sm:aspect-video lg:aspect-[4/3] rounded-3xl overflow-hidden border border-primary/30 shadow-[0_0_50px_rgba(212,175,55,0.15)] bg-surface"
            style={{
          ...
          >
            ...
            <motion.div variants={fadeIn} className="perspective-1000">
              <div
                ...
                className="group relative h-full rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-8 backdrop-blur-2xl transition-transform duration-200 ease-out hover:border-primary/50 hover:shadow-[0_20px_50px_rgba(212,175,55,0.15)]"
              ...
              >
                ...
                <div style={{ transform: "translateZ(30px)" }}>
                  <div className="mb-8 inline-flex p-4 rounded-2xl bg-primary/10 text-primary ring-1 ring-primary/30 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
      ...
      <section className="relative w-full py-40 overflow-hidden bg-background">
        ...
        >
          <div className="relative overflow-hidden rounded-3xl md:rounded-[3rem] border border-primary/30 bg-surface/40 backdrop-blur-xl md:backdrop-blur-3xl p-6 sm:p-16 md:p-24 text-center shadow-[0_0_100px_rgba(212,175,55,0.08)]">
            {/* Animated internal gradient - Disabled on mobile to prevent GPU lag */}
            <div className="absolute -inset-[100%] bg-[conic-gradient(from_90deg_at_50%_50%,#00000000_50%,#d4af37_100%)] opacity-20 animate-[spin_5s_linear_infinite] hidden md:block" />
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <Link
                href="/cotizador"
                className="group relative inline-flex h-14 sm:h-20 items-center justify-center overflow-hidden rounded-full bg-primary px-8 sm:px-16 font-bold text-background transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_80px_rgba(212,175,55,0.45)]"
              >
                <div className="absolute inset-0 flex h-full w-full justify-center [transform:skew(-12deg)_translateX(-150%)] group-hover:duration-1000 group-hover:[transform:skew(-12deg)_translateX(150%)]">
